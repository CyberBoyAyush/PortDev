...
const App = () => {
  ...
  // Hide navbar on auth and username setup pages
  const hideNavbar = ['/login', '/signup', '/username-setup'].includes(location.pathname);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900">
      ...
      <main className={hideNavbar ? '' : 'pt-16'} style={{ flexGrow: 1 }}>
        <Outlet />
      </main>
